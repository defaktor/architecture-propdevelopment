...
System_Boundary(PropDevelopment, "PropDevelopment") {
    ...
    Boundary(firewall, "Firewall") {
        Boundary(internalSystems, "Внутренние системы") {
    ...
    Boundary(externalSystems, "Внешние системы") {
        ...
        Container_Ext(smartDoor, "Интеллектуальный домофон", "API", "Распознавание лиц и управление доступом")
        Container_Ext(smartGate, "Интеллектуальный шлагбаум", "API", "Распознавание номеров автомобилей и управление доступом")
    }
